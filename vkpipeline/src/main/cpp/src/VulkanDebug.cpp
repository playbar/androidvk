...
bool gVksDebugMarkerActive = false;

int gVksDebugValidationLayerCount = 1;
const char *gVksDebugValidationLayerNames[] =
		{
...
void VksDebugMarkerSetup(VkDevice device)
{
	...
	gVksDebugMarkerActive = (pfnDebugMarkerSetObjectName != VK_NULL_HANDLE);
}
