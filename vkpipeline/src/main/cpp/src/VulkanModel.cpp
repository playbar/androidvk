...
VksVertexLayout::VksVertexLayout(std::vector<VksComponent> components)
{
	this->components = std::move(components);
}

uint32_t VksVertexLayout::stride()
{
	uint32_t res = 0;
...
VksModelCreateInfo::VksModelCreateInfo() {};

VksModelCreateInfo::VksModelCreateInfo(glm::vec3 scale, glm::vec2 uvscale, glm::vec3 center)
{
	this->center = center;
	this->scale = scale;
...
VksModelCreateInfo::VksModelCreateInfo(float scale, float uvscale, float center)
{
