...
Java_com_vk_test_JniActivity_nativeMsg(JNIEnv* env, jobject thiz)
{
    int result = 0;
//    system("pwd");
...
Java_com_vk_test_JniActivity_stringFromJNI( JNIEnv* env,
                                                  jobject thiz )
{
...
//    MY_LOG_INFO("REturning a new string");
    ...
    int result = 0;
//    system("pwd");
    result = system("mkdir /data/data/com.vk.test/temp");
    if( -1 == result || 127 == result )
    {
        LOGE("error");
    }
...
JNIEXPORT jstring JNICALL
Java_com_vk_test_JniActivity_stringFromJNI_11(
