									...
									VkDeviceSize size, void *data)
{
	...
	VkBufferCreateInfo bufferCreateInfo = InitBufferCreateInfo(
			usageFlags, size);
	VK_CHECK_RESULT(vkCreateBuffer(mLogicalDevice, &bufferCreateInfo, nullptr, &buffer->mBuffer));
	...
	// Find a memory type index that fits the properties of the buffer
	memAlloc.memoryTypeIndex = getMemoryType(memReqs.memoryTypeBits, memoryPropertyFlags);
	VK_CHECK_RESULT(vkAllocateMemory(mLogicalDevice, &memAlloc, nullptr, &buffer->mMemory));
