...
*/
struct VksFramebufferAttachment
{
    VkImage image;
...
*/
struct VksAttachmentCreateInfo
{
...
public:
    ...
    VkSampler sampler;
    std::vector<VksFramebufferAttachment> attachments;
    ...
    */
    VksFramebuffer(VulkanDevice *vulkanDevice)
    {
        assert(vulkanDevice);
    ...
    */
    uint32_t addAttachment(VksAttachmentCreateInfo createinfo)
    {
        VksFramebufferAttachment attachment;
        ...
        VkImageViewCreateInfo imageView = InitImageViewCreateInfo();
